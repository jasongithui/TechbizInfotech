...
!(function (t) {
  ...
  (i.VERSION = "3.2.0"),
    (i.prototype.close = function (e) {
      ...
      function o() {
        a.detach().trigger("closed.sppb.alert").remove(),
          "none" !== t(n).css("border-color") &&
            "none" !== t(n).css("border-style") &&
            t(n).css("border", "none");
      }
      e && e.preventDefault(),
        a.length || (a = i.hasClass("sppb-alert") ? i : i.parent()),
        a.trigger((e = t.Event("close.sppb.alert"))),
        e.isDefaultPrevented() ||
          (a.removeClass("in"),
          t.support.transition && a.hasClass("sppb-fade")
            ? a.one("bsTransitionEnd", o).emulateTransitionEnd(150)
            : o());
    });
  var n = t.fn.spbalert;
  ...
  (function (t) {
    ...
    function i(i) {
      return this.each(function () {
        ...
        s || n.data("sppb.carousel", (s = new e(this, a))),
          "number" == typeof i
            ? s.to(i)
            : o
            ? s[o]()
            : a.interval && s.pause().cycle();
      });
    }
    (e.VERSION = "3.2.0"),
      ...
      t(document).on(
        ...
        function (e) {
          var n = t(this),
            s = n.attr("href");
          s && (s = s.replace(/.*(?=#[^\s]+$)/, ""));
          var a = n.attr("data-sppb-target") || s,
            o = t(document).find(a);
          if (o.hasClass("sppb-carousel")) {
            var r = t.extend({}, o.data(), n.data()),
              l = n.attr("data-sppb-slide-to");
            l && (r.interval = !1),
              i.call(o, r),
              l && o.data("sppb.carousel").to(l),
              e.preventDefault();
          }
        }
      ),
  ...
  (function (t) {
    ...
    t(document).on("click", ".sppb-panel-heading", function (e) {
      ...
      t(this).hasClass("active")
        ? (t(this).removeClass("active"), i.next().slideUp())
        : (s.removeClass("active"),
          ...
          t(this)
            ...
            .next()
            .slideDown(function () {
              i[0].getBoundingClientRect().top < 0 &&
                t("html,body").animate({ scrollTop: i.offset().top }, 400);
            }));
    });
  })(jQuery),
  (function (t) {
      ...
      (e.prototype.show = function () {
        ...
        if (
          ...
          var s = i.find(".active:last a")[0],
            a = t.Event("show.sppb.tab", { relatedTarget: s });
            ...
            t(this)
              ...
              .each(function (e) {
                t(this).attr("id", i + "-" + (e + 1)),
                  t(this).attr("aria-labelledby", n + "-" + (e + 1));
              });
        });
      }),
      t(document).on(
    ...
    (e.VERSION = "3.2.0"),
      ...
      (e.prototype.show = function () {
        ...
        if (this.hasContent() && this.enabled) {
          ...
          if (l) {
            ...
            (o =
              "bottom" == o && p.top + p.height + h - f.scroll > f.height
                ? "top"
                : "top" == o && p.top - f.scroll - h < 0
                ? "bottom"
                : "right" == o && p.right + d > f.width
                ? "left"
                : "left" == o && p.left - d < f.left
                ? "right"
                : o),
              s.removeClass(c).addClass(o);
          }
      ...
      (e.prototype.getViewportAdjustedDelta = function (t, e, i, n) {
        ...
        if (/right|left/.test(t)) {
          ...
          r < o.top
            ? (s.top = o.top - r)
            : l > o.top + o.height && (s.top = o.top + o.height - l);
        } else {
          var p = e.left - a,
            d = e.left + a + i;
          p < o.left
            ? (s.left = o.left - p)
            : d > o.width && (s.left = o.left + o.width - d);
        }
        return s;
      }),
    ...
    (t.fn.sppbtooltip = function (i) {
      return this.each(function () {
        var n = t(this),
          ...
          a = "object" == typeof i && i;
        (s || "destroy" != i) &&
          (s || n.data("sppb.tooltip", (s = new e(this, a))),
          "string" == typeof i && s[i]());
      });
    }),
  ...
  (function (t) {
    ...
    (e.VERSION = "3.2.0"),
      ...
      ((e.prototype = t.extend(
        {},
        t.fn.sppbtooltip.Constructor.prototype
      )).constructor = e),
      (e.prototype.getDefaults = function () {
        return e.DEFAULTS;
      }),
    ...
    (t.fn.sppbpopover = function (i) {
      return this.each(function () {
        var n = t(this),
          ...
          a = "object" == typeof i && i;
        (s || "destroy" != i) &&
          (s || n.data("sppb.popover", (s = new e(this, a))),
          "string" == typeof i && s[i]());
      });
    }),
...
function lazyImageLoad(t) {
  if (0 === t.length) return;
  !(function () {
    if ("IntersectionObserver" in window) {
      const e = new IntersectionObserver(observerCallback, {
        root: null,
        rootMargin: "0px",
        threshold: 0.1,
      });
      ...
      t.forEach(function (t) {
        (t.src = t.dataset.src),
          t.classList.contains("sppb-element-lazy") &&
            t.classList.add("sppb-element-loaded");
      });
  })();
}
function mp4VideoSourchLoop(t) {
  for (var e in t.children) {
    "string" == typeof (e = t.children[e]).tagName &&
      "SOURCE" === e.tagName &&
      (e.src = e.dataset.large);
  }
  t.load();
}
function observerCallback(t, e) {
  t.forEach(function (t) {
    const i = t.target,
      n = i.querySelector(".section-bg-video"),
      s = document.querySelector(".sppb-youtube-iframe");
    t.intersectionRatio &&
      (("IMG" !== i.tagName && "IFRAME" !== i.tagName) ||
        (i.src = i.dataset.large),
      i.classList.contains("sppb-element-lazy") &&
        i.classList.add("sppb-element-loaded"),
      "VIDEO" === i.tagName && mp4VideoSourchLoop(i),
      null !== n && mp4VideoSourchLoop(n),
...
carousel &&
        ...
        return (
          ...
          (a.prototype.doSync = function (t) {
            ...
            if (!this.stopped) {
              ...
              for (
                o = [],
                  i = 0,
                  n = (a = (t = t.parentNode || t).querySelectorAll(
                    "." + this.config.boxClass
                  )).length;
                n > i;
                i++
          ...
          (a.prototype.vendorCSS = function (t, e) {
            ...
            for (
              ...
              (s = r[a]), (i = i || n.getPropertyCSSValue("-" + s + "-" + e));
            return i;
          }),
    ...
    function p() {
      ...
      if (
        ...
        for (
          e =
            e ||
            ((d = { height: o.innerHeight, width: o.innerWidth }).height ||
              (!(l = a.compatMode) && t.support.boxModel) ||
              (d = {
          ...
          if (t.contains(r, h[c])) {
            var u,
              ...
              m,
              v = t(h[c]),
              g = { height: v.height(), width: v.width() },
              b = v.offset(),
              y = v.data("inview");
            if (!i || !e) return;
            b.top + g.height > i.top &&
            b.top < i.top + e.height &&
            b.left + g.width > i.left &&
            b.left < i.left + e.width
              ? ((m =
                  (u =
                    i.left > b.left
                      ? "right"
                      : i.left + e.width < b.left + g.width
                      ? "left"
                      : "both") +
                  "-" +
                  (f =
                    i.top > b.top
                      ? "bottom"
                      : i.top + e.height < b.top + g.height
                      ? "top"
                      : "both")),
                (y && y === m) ||
                  v.data("inview", m).trigger("inview", [!0, u, f]))
              : y && v.data("inview", !1).trigger("inview", [!1]);
          }
    }
    (t.event.special.inview = {
      add: function (e) {
        (s[e.guid + "-" + this[l]] = { data: e, $element: t(this) }),
      ...
      t(a).on("scroll resize scrollstop", function () {
        e = i = null;
      }),
      !r.addEventListener &&
        r.attachEvent &&
      ...
      t(document).on("inview", ".sppb-animated-number", function (e, i, n, s) {
        var a = t(this);
        i &&
          (a.sppbanimateNumbers(
            a.data("digit"),
            Boolean(a.data("format")),
            a.data("duration")
          ),
          a.unbind("inview"));
      }),
  ...
  jQuery(function (t) {
    function e(e, n) {
      ...
      return (
        e
          .find(
            " input[type=text], input[type=email], input[type=radio], input[type=checkbox], textarea, select"
          )
          .each(function (e, a) {
            if (s) return !1;
            if (n)
              t(this).on("change keyup", function () {
                var e = t(this).val().replace(/\s/g, ""),
                  n = t(this).attr("type"),
                  a = t(this).attr("name");
                "" === e || 0 === e.length
                  ? ((s = !0), t(this).addClass("sppb-has-field-error"))
                  : ((s = !1), t(this).removeClass("sppb-has-field-error")),
                  "text" !== n ||
                  "captcha_question" === a ||
                  "phone" === a ||
                  isNaN(e) ||
                  s
                    ? ((s = !1), t(this).removeClass("sppb-has-field-error"))
                    : ((s = !0), t(this).addClass("sppb-has-field-error")),
                  void 0 !== t(this).prop("required") &&
                    e.length > 0 &&
                    "email" === n &&
                    !s &&
                    (i(e)
                      ? (t(this).removeClass("sppb-has-field-error"), (s = !1))
                      : (t(this).addClass("sppb-has-field-error"), (s = !0)));
              });
            else {
    ...
    function n(e) {
      ...
      if (void 0 !== e.prop("required")) {
        ...
        if (
          void 0 === s ||
          "undefined" === s.find("span.sppb-form-builder-required")
        )
          return !1;
        if (
          (0 === a.length &&
            e.prop("required") &&
            (s.find("span.sppb-form-builder-required").show(), (n = !0)),
          a.length > 0 &&
            e.prop("required") &&
            (s.find("span.sppb-form-builder-required").hide(), (n = !1)),
          "radio" === e.attr("type") && e.prop("required"))
        ) {
          var o = e.attr("name");
          t('input[name="' + o + '"]').is(":checked")
            ? (s.find("span.sppb-form-builder-required").hide(), (n = !1))
            : (s.find("span.sppb-form-builder-required").show(), (n = !0));
        }
    ...
    function s(e) {
      ...
      return (
        e
          ...
          .each(function (e, a) {
            if (!0 === i)
              t(this).on("change keyup", function (e) {
    ...
    e(t(".sppb-ajaxt-contact-form"), !0),
      t(document).on("submit", ".sppb-ajaxt-contact-form", function (i) {
        i.preventDefault();
        var n = t(this),
        ...
        if (e(n))
          return (
            ...
            n.append(
              '<p class="sppb-form-validation-error"> Please re-check required fields! </p>'
            ),
            !1
          );
        n.find(".sppb-form-validation-error").remove();
          ...
          t.ajax({
            ...
            success: function (e) {
              ...
              "json" == o
                ? s.status &&
                  (n.trigger("reset"),
                  void 0 === s.gcaptchaType ||
                    !s.gcaptchaType.length ||
                    ("invisible" != s.gcaptchaType &&
                      "dynamic" != s.gcaptchaType) ||
                    ((gcaptchaWidgetId = t("#" + s.gcaptchaId).attr(
                      "data-recaptcha-widget-id"
                    ))
                      ? (grecaptcha.reset(gcaptchaWidgetId),
                        "invisible" == s.gcaptchaType &&
                          grecaptcha.execute(gcaptchaWidgetId))
                      : (grecaptcha.reset(),
                        "invisible" == s.gcaptchaType && grecaptcha.execute())))
                : n.trigger("reset"),
                n.find(".fa-spin").removeClass("fa-spinner fa-spin"),
                n
      ...
      t(".sppb-addon-form-builder-form").length > 0 &&
        (s(t(".sppb-addon-form-builder-form"), !0),
        t('.sppb-form-builder-range input[type="range"]').on(
          "input change",
          function () {
            var e = t(this),
              i = e.attr("min"),
            ...
            e.next(".sppb-form-builder-range-output")
              .css("left", "calc(" + a + "% - " + o + "px)")
              .text(s);
          }
        )),
        ...
        if (a)
          return (
            i
              .next(".sppb-ajax-contact-status")
              .html(
                '<span class="sppb-text-danger">Please check the required field!</span>'
              )
              .fadeIn()
              .delay(4e3)
              .fadeOut(500),
          ...
          t.ajax({
            ...
            success: function (e) {
              ...
              "json" == p
                ? a.status &&
                  (i.trigger("reset"),
                  void 0 === a.gcaptchaType ||
                    !a.gcaptchaType.length ||
                    ("invisible" != a.gcaptchaType &&
                      "dynamic" != a.gcaptchaType) ||
                    (a.gcaptchaId
                      ? (gcaptchaWidgetId = t("#" + a.gcaptchaId).attr(
                          "data-recaptcha-widget-id"
                        )) &&
                        (grecaptcha.reset(gcaptchaWidgetId),
                        "invisible" == a.gcaptchaType &&
                          grecaptcha.execute(gcaptchaWidgetId))
                      : (grecaptcha.reset(),
                        "invisible" == a.gcaptchaType && grecaptcha.execute())))
                : i.trigger("reset"),
              ...
              return (
                ...
                n.message
                  ? i
                      ...
                      .html(
                        '<p class="sppb-alert sppb-alert-warning">' +
                          n.message +
                          "</p>"
                      )
                      .fadeIn()
  ...
  (function (t) {
    function e() {
      if (
        ...
        "undefined" != typeof stickyParent && 0 != stickyParent.length)
      ) {
    ...
    (window.sppbVideoBackgroundResize = function (t) {
      ...
      t(document).ready(function () {
        void 0 !== jQuery.fn.parallax &&
          t('[data-sppb-parallax="on"]').each(function () {
            t(this).parallax();
          });
        const e = document.getElementsByClassName("section-bg-video");
        if (((e.volume = 0), t(window).width() < 767)) {
          for (let t = 0; t < e.length; t++);
          t(document).on("touchend touchcancel", function () {
            !(function () {
              for (let t = 0; t < e.length; t++) e[t].paused && e[t].play();
            })();
          });
        }
        const i = t(".sppb-positioned-addon");
        i.length > 0 &&
          i.each(function () {
            var e = t("#section-id-" + t(this).data("rowid")),
              i = t(this).data("zindex"),
              n = t("#column-wrap-id-" + t(this).data("colid")).find(
                ".sppb-column"
              ),
          ...
          t.forEach(function (t) {
            ...
            null !== e &&
              jQuery(e).each(function () {
                jQuery(this)
                  .find(".sppb-article-scroller-wrap")
                  .each(function () {
        ...
        new MutationObserver(function (t) {
          t.forEach(function (t) {
            ...
            null !== e &&
              jQuery(e).each(function () {
                jQuery(this)
                  .find(".sppb-articles-carousel")
                  .each(function () {
                    var t = jQuery(this).data("type"),
                      e = jQuery(this).data("articles"),
                      i = jQuery(this).data("articles-tab"),
                      n = jQuery(this).data("articles-mobile"),
                      s = jQuery(this).data("speed"),
                      a = jQuery(this).data("autoplay"),
                      o = jQuery(this).data("drag"),
                      r = jQuery(this).data("arrow");
                    jQuery(function () {
                      t
                        ? jQuery(".sppb-articles-carousel-wrap")
        ...
        new MutationObserver(function (t) {
          t.forEach(function (t) {
            ...
            null !== e &&
              jQuery(e).each(function () {
                jQuery(this)
                  .find(".sppb-addon-articles-ticker")
                  .each(function () {
                    ...
                    jQuery("#" + t + " .sppb-articles-ticker-content").bxSlider(
                      {
                        ...
                        nextSelector: ".sppb-articles-ticker-right-control",
                        prevSelector: ".sppb-articles-ticker-left-control",
                        auto: !0,
                        adaptiveHeight: !0,
                        autoHover: !0,
                        touchEnabled: !1,
  ...
  (function (t) {
    (t.fn.basictable = function (e) {
      var i = function (e, i) {
          var s = [];
          if (
            (i.tableWrap && e.wrap('<div class="bt-wrapper"></div>'), i.header)
          ) {
            var a = "";
            ...
            if (
              ...
              for (var s = e.index(), a = "", o = 0; o < i.length; o++) {
                ...
                var r = i[o][s],
                  l = r.find("div");
                l.length > 0
                  ? (a += (r = t(l[l.length - 1])).text())
                  : (a += r.text());
              }
              e.attr("data-th", a.trim()),
                n.contentWrap &&
        ...
        s = function (e, i) {
          i.forceResponsive
            ? (null !== i.breakpoint && t(window).width() <= i.breakpoint) ||
              (null !== i.containerBreakpoint &&
                e.parent().width() <= i.containerBreakpoint)
              ? a(e, i)
              : o(e, i)
        ...
        if (0 === n.length || n.data("basictable")) {
          if (n.data("basictable")) {
            ...
            "destroy" === e
              ? r(n, l)
              : "restart" === e
              ? (r(n, l), n.data("basictable", l), i(n, l), s(n, l))
              : "start" === e
              ? a(n, l)
              : "stop" === e
              ? o(n, l)
      ...
      (t.fn.addSortWidget = function (e) {
        e = t.extend(
          {},
          { sort_asc: "sort-asc", sort_desc: "sort-desc", no_sort: "no-sort" },
          e
        );
        var i = t(this),
          n = !0;
        return (
          t("th", i).each(function (s) {
            t("<div>")
              .addClass("sppb-table-addon-sortable")
              .attr("data-content", e.no_sort)
              .on("click", function () {
                t(".sppb-table-addon-sortable", i).attr(
                  "data-content",
                  e.no_sort
                ),
                  t(this).attr("data-content", n ? e.sort_desc : e.sort_asc),
                  (n = !n);
      ...
      (t.fn.pageMe = function (e) {
        var i = t.extend(
          ...
          o = n.children(),
          r = t(".pager");
        void 0 !== i.childSelector && (o = n.find(i.childSelector)),
          void 0 !== i.pagerSelector &&
            this.next().length &&
            (r = this.next().find(i.pagerSelector));
        var l = o.length ?? 0,
          p = Math.ceil(l / s);
        this.next().length &&
          this.next()
            .find(".sppb-table-total-reg")
            .html("Total Entries: " + l),
          r.data("curr", 0),
          i.showPrevNext &&
            t(
              '<li class="sppb-page-item"><a href="#" class="sppb-table-prev-link sppb-page-link" title="' +
                i.prevText +
                '"><i aria-hidden="true" class="fa fa-angle-left"></i></a></li>'
            ).appendTo(r);
        for (var d = 0; p > d && 0 == i.hidePageNumbers; )
          t(
            '<li class="sppb-page-item"><a href="#" class="sppb-table-paginate-link sppb-page-link">' +
              (d + 1) +
              "</a></li>"
          ).appendTo(r),
            d++;
        function h(t) {
          var e = t * s,
            i = e + s;
          o.css("display", "none").slice(e, i).show(),
            t >= 1
              ? r.find(".sppb-table-prev-link").show()
              : r.find(".sppb-table-prev-link").hide(),
            t < p - 1
              ? r.find(".sppb-table-next-link").show()
              : r.find(".sppb-table-next-link").hide(),
            r.data("curr", t),
        ...
        i.showPrevNext &&
          t(
            '<li class="sppb-page-item"><a href="#" class="sppb-table-next-link sppb-page-link"  title="' +
              i.nextText +
              '"><i aria-hidden="true" class="fa fa-angle-right"></i></a></li>'
          ).appendTo(r),
          r.find(".sppb-table-prev-link").hide(),
          p <= 1 && r.find(".sppb-table-next-link").hide(),
          r.children().eq(1).addClass("active"),
          o.hide(),
          o.slice(0, s).show(),
          r.find("li .sppb-table-paginate-link").click(function () {
            return (
              h(t(this).html().valueOf() - 1),
              a && n.find("tr:first-child").show(),
              !1
            );
          }),
          r.find("li .sppb-table-prev-link").click(function () {
            return (
              h(parseInt(r.data("curr")) - 1),
              a && n.find("tr:first-child").show(),
              a && n.find("tr:first-child").show(),
              !1
            );
          ...
          r.find("li .sppb-table-next-link").click(function () {
            return (
              (goToPage = parseInt(r.data("curr")) + 1),
              h(goToPage),
              a && n.find("tr:first-child").show(),
              a && n.find("tr:first-child").show(),
              !1
      ...
      t(document).ready(function () {
        t(".sppb-addon-table-main").length > 0 &&
          t(".sppb-addon-table-main").each(function (e) {
            ...
            if (s) {
              ...
              t(h).keyup(function () {
                !(function (t, e, i) {
                  if (
                    (void 0 === i && (i = "0"),
                    0 != e.length && /^[0-9]*$/.test(i))
                  )
                    for (var n = 0; n < e.length; n++) {
                      for (var s = "false", a = 0; a < i.length; a++)
                        if (
                          e.eq(n).children().length > i[a] &&
                          -1 !=
                            e
                              .eq(n)
                              .children()
                      ...
                      "success" == s
                        ? e
                            .eq(n)
                            .addClass("sppb-table-addon-item-search")
                            .show()
                        : e
                            .eq(n)
                            .removeClass("sppb-table-addon-item-search")
                            .hide();
                    }
                })(t(h).val().toLowerCase(), t(r).find("tbody tr"), o),
                  d && t(r).find("tr:first-child").show(),
                  l.length > 0 &&
                    (l.html(""),
                    setTimeout(function () {
                      t(r).pageMe({
  ...
  window.addEventListener("DOMContentLoaded", function () {
    let t = document.querySelectorAll(".sppb-element-lazy");
    if (!t.length) {
      const e = document.getElementById("sp-pagebuilder-view");
      if (null !== e)
        return void e.addEventListener("load", function () {
          const i = e.contentWindow.document;
          (t = i.querySelectorAll(".sppb-element-lazy")), lazyImageLoad(t);
        });
    }
    lazyImageLoad(t);
  }),
      ...
      new MutationObserver(function (e) {
        e.forEach(function (e) {
          ...
          null != i &&
            t(i).each(function () {
              t(this)
                .find(".sppb-element-lazy")
                .each(function () {
                  t(this).addClass("sppb-element-loaded");
                  var e = this.querySelectorAll("SOURCE");
                  for (const t of e)
                    this instanceof HTMLVideoElement &&
                      t &&
                      t.setAttribute("src", t.dataset.large);
                });
            });
        });
      }).observe(document.body, { childList: !0, subtree: !0 });
...
!(function (t) {
  ...
  (e.prototype.bindCustomAnimation = function () {
    ...
    (e.prototype.getCustomAnimationActionByName = function (t) {
      ...
      if (null === e)
        return void 0 !== this.actionSortList[t] ? this.actionSortList[t] : [];
      var i = { from: null, to: null },
        n = void 0 !== this.actionSortList[t] ? this.actionSortList[t] : [];
      if (0 === n.length) return i;
      var s = !1;
      return (
        n.map(function (t, a) {
          e < parseInt(t.keyframe) &&
            null === i.to &&
            (void 0 !== i.fixed && delete i.fixed,
            (t.toKF = 0),
            (i.to = t),
            void 0 !== n[a - 1] && ((n[a - 1].scroll = 0), (i.from = n[a - 1])),
            (s = !0)),
            a === n.length - 1 &&
              !1 === s &&
              ((i.fixed = !0),
    ...
    (e.prototype.getMoveTransform = function (t, e, i) {
      var n = e.to.keyframe,
        s = e.from.keyframe,
        a = { toKF: isNaN(n) ? 100 : Math.abs(s - n), fromKF: s, totalKF: n },
        o = e.from.x,
        r = e.to.x,
        l = e.from.y,
        p = e.to.y,
        ...
        h = e.to.z;
      return (
        (e.goal.x = this.getTAxis(o, r, i, a)),
        (e.goal.y = this.getTAxis(l, p, i, a)),
        (e.goal.z = this.getTAxis(d, h, i, a)),
        e
      );
    }),
              ...
              value: function () {
                if (
                  (null !== this.element.parentElement &&
                    "sppb-addon-wrapper" ===
                      this.element.parentElement.className &&
                    (this.element = this.element.parentElement),
                  "sppb-addon-wrapper" !== this.element.className)
                ) {
                  var t = document.createElement("div");
                  t.setAttribute("class", "sppb-addon-wrapper"),
            ...
            },
            {
              ...
              value: function () {
                if ("sppb-addon-wrapper" === this.element.className) {
                  ...
                  if (t.length > 0) {
                    var e = this.element.parentNode.insertBefore(
                      t[0],
                      this.element
                    );
  ...
  var o = {};
  function r(e) {
    void 0 !== addonInteraction.mouse_movement &&
      addonInteraction.mouse_movement.map(function (n) {
        var s = t("#sppb-addon-" + n.addonId);
        if (
          (s.parent().hasClass("sppb-addon-wrapper") ||
            s.wrap('<div class="sppb-addon-wrapper"></div>'),
          e < 768 && !1 === n.enable_mobile)
        )
          return (
            void 0 !== o[n.addonId] &&
              (o[n.addonId].tiltIntance.destroy(), delete o[n.addonId]),
            !1
          );
        if (e > 767 && e < 991 && !1 === n.enable_tablet)
          return (
            void 0 !== o[n.addonId] &&
              (o[n.addonId].tiltIntance.destroy(), delete o[n.addonId]),
            !1
  ...
  function p(t, i) {
    var n = {
      ...
      o = new e(s);
    return (
      o.bindCustomAnimation(),
      o.actionProperty.map(function (t) {
        var e = o.getCustomAnimationActionByName(t, i);
        null !== e.from &&
          (Object.assign(n[t].from, e.from.property),
          (n[t].from.f = !0),
          (n[t].from.keyframe = parseInt(e.from.keyframe)),
          void 0 !== n[t].from.x &&
            (n[t].from.x = "" === n[t].from.x ? 0 : parseFloat(n[t].from.x)),
          void 0 !== n[t].from.y &&
            (n[t].from.y = "" === n[t].from.y ? 0 : parseFloat(n[t].from.y)),
          void 0 !== n[t].from.z &&
            (n[t].from.z = "" === n[t].from.z ? 0 : parseFloat(n[t].from.z)),
          void 0 !== n[t].from.value &&
            (n[t].from.value =
              "" === n[t].from.value ? 0 : parseFloat(n[t].from.value))),
          null !== e.to &&
            (Object.assign(n[t].to, e.to.property),
            void 0 !== n[t].to.x &&
              ((n[t].to.x = "" === n[t].to.x ? 0 : parseFloat(n[t].to.x)),
              (n[t].goal.x = n[t].to.x)),
            void 0 !== n[t].to.y &&
              ((n[t].to.y = "" === n[t].to.y ? 0 : parseFloat(n[t].to.y)),
              (n[t].goal.y = n[t].to.y)),
            void 0 !== n[t].to.z &&
              ((n[t].to.z = "" === n[t].to.z ? 0 : parseFloat(n[t].to.z)),
              (n[t].goal.z = n[t].to.z)),
            void 0 !== n[t].to.value &&
              ((n[t].to.value =
                "" === n[t].to.value ? 0 : parseFloat(n[t].to.value)),
              (n[t].goal.value = n[t].to.value)),
            (n[t].to.keyframe = parseInt(e.to.keyframe)),
            (n[t].to.f = !0)),
          !0 === n[t].to.f &&
            !0 === n[t].from.f &&
            void 0 === e.fixed &&
            (n[t] =
              "opacity" === t || "blur" === t
                ? o.getOpacity(t, n[t], i)
                : "skew" === t
                ? o.getSkew(t, n[t], i)
                : o.getMoveTransform(t, n[t], i));
      }),
      {
  ...
  window.addEventListener("DOMContentLoaded", function (e) {
    "undefined" != typeof addonInteraction &&
      (r(s),
      (function () {
        ...
        t(document).ready(function () {
          e.map(function (e) {
            ...
            i.parent().hasClass("sppb-addon-wrapper") ||
              i.wrap('<div class="sppb-addon-wrapper"></div>'),
              (n[e.addonId] = i),
              i.addClass("sppb-interaction-hide");
            var o = a(i.parent("div.sppb-addon-wrapper"));
            l(i, e, o, !0);
            var r = setTimeout(function () {
              i.removeClass("sppb-interaction-hide"), clearTimeout(r);
            }, 500);
          });
        }),
            ...
            t(document).on("scroll", function () {
              (s = i.width()),
                e.map(function (e) {
                  ...
                  if (s > 767 && s < 991 && !1 === e.enable_tablet)
                    return (
                      i.css({
                        willChange: "transform",
                        "-webkit-transition-timing-function": "ease",
                  ...
                  var n = a(
                    i.parent("div.sppb-addon-wrapper"),
                    e.scrolling_options
                  );
                  l(i, e, n);
                });
